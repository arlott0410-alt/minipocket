...
export const api = {
  ...
  getWalletShares: (id) => request(`/api/wallets/${id}/shares`),
  createShareInvite: (id, body) => request(`/api/wallets/${id}/share-invites`, { method: "POST", body }),
  cancelShareInvite: (id, inviteId) => request(`/api/wallets/${id}/share-invites/${inviteId}`, { method: "DELETE" }),
  getIncomingShareInvites: () => request("/api/wallets/share-invites/incoming"),
  respondShareInvite: (inviteId, action) => request(`/api/wallets/share-invites/${inviteId}/respond`, { method: "POST", body: { action } }),
  createShareLink: (id, body) => request(`/api/wallets/${id}/share-links`, { method: "POST", body }),
  revokeShareLink: (id, linkId) => request(`/api/wallets/${id}/share-links/${linkId}`, { method: "DELETE" }),
  getShareLinkInfo: (token) => request(`/api/wallets/share-links/${token}`),
  joinShareLink: (token) => request(`/api/wallets/share-links/${token}/join`, { method: "POST" }),
